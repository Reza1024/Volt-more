...
Servo servoFL, servoFR;
Servo servoBL, servoBR;
...
void loop()
{
  ...
  if (irrecv.decode(&results)) {
    ...
    {
      if (!servoFL.attached()) servoFL.attach(9);
      if (!servoFR.attached()) servoFR.attach(10);
      if (!servoBL.attached()) servoBL.attach(11);
      if (!servoBR.attached()) servoBR.attach(12);
      servoFL.write(180 - left);
      servoBL.write(180 - left);
      servoFR.write(right);
      servoBR.write(right);
    }
  }
